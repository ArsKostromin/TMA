...
class GiftInline(admin.TabularInline):
    model = Gift
    extra = 0
    fields = ("name", "rarity_level", "price_ton", "image_preview", "ton_contract_address", "created_at")
    readonly_fields = ("name", "rarity_level", "price_ton", "image_preview", "ton_contract_address", "created_at")
    can_delete = False
